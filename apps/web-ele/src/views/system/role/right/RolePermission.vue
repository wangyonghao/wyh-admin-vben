...
<template>
  <div class="h-full flex flex-col bg-background">
    <!-- 操作栏 -->
    <div class="flex items-center justify-between px-6 py-3 border-b bg-card">
      <div class="flex items-center gap-4">
        ...
        <div class="flex items-center gap-2 text-sm text-muted-foreground">
          ...
          <label class="flex items-center gap-1.5 cursor-pointer">
            <input
              type="checkbox"
              :checked="roleDetail.menuCheckStrictly"
      ...
      <div class="flex items-center gap-2">
        <VbenButton variant="outline" size="sm">
          <IconifyIcon icon="lucide:chevrons-down" class="w-4 h-4" />
        </VbenButton>
        <VbenButton variant="outline" size="sm">
          <IconifyIcon icon="lucide:chevrons-up" class="w-4 h-4" />
        </VbenButton>
      </div>
    </div>
